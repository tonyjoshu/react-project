...
import yellowCardTabValues from "../data/yellow-card-tab-values";

function YellowCardTab({ rightSideHook, tabIndex }) {
  const {label, value, options, onChange, minuteValues} = yellowCardTabValues(rightSideHook, tabIndex)
  return (
    <Column style={{ gap: 0 }}>
      <Label
        small
